> **Note:** This guide maps DDD concepts onto the **legacy banking demo** (accounts /
> deposits / transfers) that lived on the pre-MES branch. It is kept as a worked example;
> the current mainline is the semiconductor MES kernel. The saga guide lives in
> [docs/SAGA_GUIDE.md](../SAGA_GUIDE.md).
