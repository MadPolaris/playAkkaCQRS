...
class SagaTransactionStepSerializer extends Serializer {
  ...
  override def toBinary(o: AnyRef): Array[Byte] = o match {
    case step: SagaTransactionStep[_, _] =>
     proto.saga_v2.SagaTransactionStep(
        stepId = step.stepId,
        phase = step.phase match {
          case PreparePhase =>proto.saga_v2.TransactionPhase.PREPARE_PHASE
          case CommitPhase =>proto.saga_v2.TransactionPhase.COMMIT_PHASE
          case CompensatePhase =>proto.saga_v2.TransactionPhase.COMPENSATE_PHASE
        },
  ...
  override def fromBinary(bytes: Array[Byte], manifest: Option[Class[_]]): AnyRef = {
    val protoStep =proto.saga_v2.SagaTransactionStep.parseFrom(bytes)
    SagaTransactionStep(
      stepId = protoStep.stepId,
      phase = protoStep.phase match {
        case proto.saga_v2.TransactionPhase.PREPARE_PHASE => PreparePhase
        case proto.saga_v2.TransactionPhase.COMMIT_PHASE => CommitPhase
        case proto.saga_v2.TransactionPhase.COMPENSATE_PHASE => CompensatePhase
